...
fn main() {
    ...
    fn print_cooordinates(&(x, y): &(i32, i32)) {
        println!("Current location: ({}, {})", x, y);
    }

    let point = (3, 5);
    print_cooordinates(&point);
    ...
    match msg {
        ...
        Message::ChangeColor(Color::Hsv(h, s, v)) => println!("Change the color to blue {}, saturation {}, and value {}", h, s, v),
        _ => (),
    }
